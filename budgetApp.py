class Budget:
    def __init__(self, **categories):
        ...
        print(
            f'Your utility budget for this month is currently {self.categories}')
        ...
        def deposit(self, category, deposit_amount):
            ...
            if category in self.categories:
                ...
                print(
                    f'You have successfully deposited ${deposit_amount} for {category}')
            else:
        ...
        def withdrawal(self, category, withdrawal_amount):
            ...
            if category in self.categories:
                if withdrawal_amount <= self.categories[category]:
                    ...
                    print(
                        f'You have successfully withdrawn ${withdrawal_amount} from {category}')
                else:
        ...
        def transfer(self, transfer_from, transfer_to, transfer_amount):
            ...
            if transfer_from in self.categories and transfer_to in self.categories:
                 ...
                 if self.categories[transfer_from] >= transfer_amount:
                     ...
                     print(
                         f'You have successfully transferred ${transfer_amount} from {transfer_from} category to {transfer_to} category')
                 else: 
